...
public final class NitroRealFetchAutolinking {
   ...
   */
  public static func createDuplexStream() -> bridge.std__shared_ptr_margelo__nitro__realfetch__HybridDuplexStreamSpec_ {
    let hybridObject = HybridDuplexStream()
    return { () -> bridge.std__shared_ptr_margelo__nitro__realfetch__HybridDuplexStreamSpec_ in
      let __cxxWrapped = hybridObject.getCxxWrapper()
      return __cxxWrapped.getCxxPart()
    }()
  }
