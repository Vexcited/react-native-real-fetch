...
namespace margelo::nitro::realfetch {
  ...
  public:
    ...
    explicit HybridDuplexStreamSpecSwift(const NitroRealFetch::HybridDuplexStreamSpec_cxx& swiftPart):
      HybridObject(HybridDuplexStreamSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroRealFetch::HybridDuplexStreamSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroRealFetch::HybridDuplexStreamSpec_cxx _swiftPart;
  };
