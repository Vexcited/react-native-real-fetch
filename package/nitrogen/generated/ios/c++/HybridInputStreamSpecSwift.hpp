...
namespace margelo::nitro::realfetch {
  ...
  public:
    ...
    explicit HybridInputStreamSpecSwift(const NitroRealFetch::HybridInputStreamSpec_cxx& swiftPart):
      HybridObject(HybridInputStreamSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroRealFetch::HybridInputStreamSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroRealFetch::HybridInputStreamSpec_cxx _swiftPart;
  };
