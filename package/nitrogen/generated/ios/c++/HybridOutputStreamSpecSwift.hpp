...
namespace margelo::nitro::realfetch {
  ...
  public:
    ...
    explicit HybridOutputStreamSpecSwift(const NitroRealFetch::HybridOutputStreamSpec_cxx& swiftPart):
      HybridObject(HybridOutputStreamSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroRealFetch::HybridOutputStreamSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroRealFetch::HybridOutputStreamSpec_cxx _swiftPart;
  };
