 ...
 */
open class HybridOutputStreamSpec_cxx {
  /**
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_HybridOutputStreamSpec_
   ...
   * The C++ part is a `std::shared_ptr<HybridOutputStreamSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_HybridOutputStreamSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if cachedCxxPart.__convertToBool() {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_HybridOutputStreamSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_HybridOutputStreamSpec_(newCxxPart)
      return newCxxPart
    }
  }
  ...
  // Methods
  @inline(__always)
  public final func write(buffer: ArrayBuffer) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
